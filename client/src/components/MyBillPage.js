        ...
        <ul className="nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4 mx-24" id="tabs-tab"
          ...
          <li className="nav-item" role="presentation">
            ...
            " id="tabs-profile-tab" data-bs-toggle="pill" data-bs-target="#tabs-profile" role="tab"
              aria-controls="tabs-profile" aria-selected="false">Credit</button>
          </li>
                    ...
                    <div className="flex flex-col card bg-base-100 shadow-lg m-5">
                      <div className="card-body mx-20 ">
                        ...
                        <div className="flex flex-row justify-between w-full">
                          ...
                          <span className="font-bold text-slate-700">{boughtHistoryCash.boughtDate}</span>
                        </div>
                        <div className="flex flex-row justify-between w-full">
                          <span className="font-semibold text-slate-500">Total Price</span>
                          <span className="font-bold text-slate-700">{boughtHistoryCash.price}</span>
                        </div>
                        <div className="flex flex-row justify-between w-full">
                          <span className="font-semibold text-slate-500">Status</span>
                          {
                            boughtHistoryCash.paidOff === true ? <span className="font-semibold bg-green-600 text-white rounded-md px-2">Already Paid</span> : <span className="font-semibold bg-red-600 text-white rounded-md px-2">Not Paid</span> 
                          }
                        </div>
                        <div className="flex flex-row justify-between w-full">
                          <span className="font-semibold text-slate-500">Order Id</span>
                          <span className="font-bold text-slate-700">{boughtHistoryCash.orderId}</span>
                        </div>
                      </div>
                    </div> 
                  </div>
